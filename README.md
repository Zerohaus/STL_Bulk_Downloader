...
**Desktop v2.0.2** — see [README-DESKTOP.md](README-DESKTOP.md) for the current GUI workflow, [CHANGELOG.md](CHANGELOG.md) for release notes, [DESKTOP_EXE.md](DESKTOP_EXE.md) to build the installer.
